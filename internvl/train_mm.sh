...
# Submit:
#   qsub -v MODEL=1b /projectnb/cs585/students/mkd/740/WalkVL/internvl/train_mm.sh
#   qsub -v MODEL=4b /projectnb/cs585/students/mkd/740/WalkVL/internvl/train_mm.sh
...
OUTPUT=$EXP/checkpoints/internvl2-${MODEL}-mm

echo "============================================"
echo "WalkVL InternVL training"
echo "Mode     : RGB + Instance + Depth + route"
echo "Model    : $MODEL_ID"
echo "Data     : $DATA"
echo "Output   : $OUTPUT"
echo "Log dir  : $LOGS"
